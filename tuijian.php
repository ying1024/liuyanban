				...
				<tr>
					<td height="50px" style="display: flex;">
						...
						<a class="c_a" href="tuijian.php">
							<li class="c_li"  style="color: #fff;background: #999999;">近期推荐</li>
						</a>
						...
						<div class="c_nr">
							...
							<div class="c_show">
								<?php
									...
									$page_size=6;
									$result=$pdo->query("select content from tb_liuyan where biaoji=1");
									$message_count=$result->rowCount();
									$page_count=ceil($message_count/$page_size);
									$offset=($page-1)*$page_size;
									$result=$pdo->query("select name,ht,content,time from tb_liuyan where biaoji=1 order by time desc limit $offset,$page_size");
							...
							<div class="c_page" align="center">
									...
									<?php
										if($page!=1){
										echo "<a href=tuijian.php?page=1>首页</a>&nbsp;&nbsp;&nbsp;";
										echo "<a href=tuijian.php?page=".($page-1).">上一页</a>&nbsp;&nbsp;&nbsp;";
										}
										if($page<$page_count){
										echo "<a href=tuijian.php?page=".($page+1).">下一页</a>&nbsp;&nbsp;&nbsp;";
										echo "<a href=tuijian.php?page=".$page_count.">尾页</a>&nbsp;&nbsp;&nbsp;";
										}
									?>
