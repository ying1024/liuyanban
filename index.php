				...
				<tr>
					<td height="50px" style="display: flex;">
						<a class="c_a" href="index.php">
							<li class="c_li"  style="color: #fff;background: #999999;">所有留言</li>
						</a>
						...
						<div class="c_nr">
							...
							<div class="c_show">
								<?php
									...
									$page_size=6;
									$result=$pdo->query("select content from tb_liuyan");
									$message_count=$result->rowCount();
									$page_count=ceil($message_count/$page_size);
									$offset=($page-1)*$page_size;
									$result=$pdo->query("select name,ht,content,time from tb_liuyan order by time desc limit $offset,$page_size");
