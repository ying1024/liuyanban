			...
			<table class="c_table1" cellspacing="0" cellpadding="0" border="1" bordercolor="#ddd" width="800px">
				<tr>
					<td height="50px" style="display: flex;">
						...
						<a class="c_a" href="mywords.php"  style="color: #fff;background: #999999;">
						...
						<div class="c_nr">
							...
							<div class="c_show">
								<?php
									...
									$page_size=6;
									$result=$pdo->query("select content from tb_liuyan where name='$username'");
									$message_count=$result->rowCount();
									$page_count=ceil($message_count/$page_size);
									$offset=($page-1)*$page_size;
									$result=$pdo->query("select name,ht,content,time from tb_liuyan where name='$username' order by time desc limit $offset,$page_size");
									...
									if(!$row){
										...
										if($row['ht'])
										echo "<div class='c_content'><span class='c_name'>$row[name]：</span><a href=''>#$row[ht]#</a>&nbsp;&nbsp;$row[content]<br><span class='c_time'>&nbsp;&nbsp;&nbsp;$row[time]</span></div>";
										else
										echo  "<div class='c_content'><span class='c_name'>$row[name]：</span>$row[content]<br><span class='c_time'>&nbsp;&nbsp;&nbsp;$row[time]</span></div>";
							...
							<div class="c_page" align="center">
									...
									<?php
										if($page!=1){
										echo "<a href=mywords.php?page=1>首页</a>&nbsp;&nbsp;&nbsp;";
										echo "<a href=mywords.php?page=".($page-1).">上一页</a>&nbsp;&nbsp;&nbsp;";
										}
										if($page<$page_count){
										echo "<a href=mywords.php?page=".($page+1).">下一页</a>&nbsp;&nbsp;&nbsp;";
										echo "<a href=mywords.php?page=".$page_count.">尾页</a>&nbsp;&nbsp;&nbsp;";
										}
									?>
