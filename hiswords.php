						...
						<div class="c_nr">
							...
							<div class="c_show">
								<?php
									...
									$page_size=6;
									$result=$pdo->query("select content from tb_liuyan where name='$he'");
									$message_count=$result->rowCount();
									$page_count=ceil($message_count/$page_size);
									$offset=($page-1)*$page_size;
									$result=$pdo->query("select name,ht,content,time from tb_liuyan where name='$he' order by time desc limit $offset,$page_size");
							...
							<div class="c_page" align="center">
									...
									<?php
										if($page!=1){
										echo "<a href=hiswords.php?page=1&he=$he>首页</a>&nbsp;&nbsp;&nbsp;";
										echo "<a href=hiswords.php?page=".($page-1)."&he=$he>上一页</a>&nbsp;&nbsp;&nbsp;";
										}
										if($page<$page_count){
										echo "<a href=hiswords.php?page=".($page+1)."&he=$he>下一页</a>&nbsp;&nbsp;&nbsp;";
										echo "<a href=hiswords.php?page=".$page_count."&he=$he>尾页</a>&nbsp;&nbsp;&nbsp;";
										}
									?>
